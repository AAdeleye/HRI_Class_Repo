...
class PozyxLocalization:
    def __init__(self):
        ...
        # (device_id, x, y, z)
        anchors_simple = [(0x6E30, 10290, 2020, 90),
                      (0x6969, 26930, 10, 950),
                      (0x6E60, 0, 0, 90),
                      (0x6E52, 45610, 2040, 1040)]
        anchors = []
        ...
        # 300 mm between tags suggests interaction; use the last 10 top interactions
        interact = interaction.Interaction(tags, 250, 10)
